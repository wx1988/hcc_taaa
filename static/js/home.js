...
function CenterClearControl(controlDiv, map) {
	...
	controlUI.addEventListener('click', function() {
		...
		renderNewMarkers(map, selectedMarker, onscreenMarker);
	});
}
...
//TODO FOR XING, update too frequently
bound = map.getBounds();
...
function getEventCB(data){
	...
	onscreenAccList = data.data;
	onscreenMarker = getAndRenderInitMarkers(map, onscreenAccList);
}
